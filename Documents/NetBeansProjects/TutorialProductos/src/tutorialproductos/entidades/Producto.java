 ...
 */
package tutorialproductos.entidades;
...
public class Producto {
    ...
    public String toString() {
        return idProducto+" "+" Producto{" + "codigo" + codigo + ", descripcion" + descripcion + ", stock" + stock; //To change body of generated methods, choose Tools | Templates.
    }
